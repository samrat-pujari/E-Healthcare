    ...
    <div class="navbar-header">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">             
        <ul class="nav navbar-nav navbar-right">
          ...
          echo '('.$count1.')'?></i></a></li>
          <li><a href="../messages/d_message.php?mid=1"><i class="fa fa-comments"><?php if($count1>0)
          {
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner" role="listbox" >
    <div class="item active">
      <img src="../pic/d3.jpg" alt="img1" title="Doctor Home Page" style="height: ; width: 100%;">
      <div class="w3-display-middle w3-margin-top w3-center">
        <h1 class="w3-xxlarge w3-text-white"><ol class="w3-padding w3-opacity-min">
        <b>You can Update Appointment Schedule, Cancel Booking Request. You can also see Appointment's Request .</b></ol></h1>
      </div>
    </div>
  </div>
</div>
