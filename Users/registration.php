	...
	<label for="gender"style="font-size:16px"><i class="fa fa-user"></i>   Gender: *</label>
	<br /><br />
	<input type="radio" name="gender"requiredstyle="font-size:16px" value="male"><b style="font-size:16px">Male</b>
	<br /><br />
	<input type="radio" name="gender"required value="female"><b style="font-size:16px">Female</b><br /><br />
	<b style="font-size:16px">Maritial Status:</b>
	</label><br /><br />
	...
	<br /><br />
	<input type="radio" name="maritialstatus"style="font-size:16px"  value="single"><b style="font-size:16px">Single</b><br /><br /><hr >
	<label for="pswd" style="font-size:16px"><i class="fa fa-key icon"></i>  Create New Password: *</label>
	<br /><br />
	<input type = "password"placeholder="Create Your password" name="pswd"required>  <p style="font-size:16px"> password should be more than 8 characters long </p>
