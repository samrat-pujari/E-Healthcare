...
padding:0;
	...
	background-image:url(../pic/healthcare.jpg);
...
<div class="w3-col 18 s12">
  ...
  <div class="w3-card-4 w3-margin " style="background-color:#B8DFD8;">
	      ...
	      $row = mysqli_fetch_array($show_run_doctor_profile_query);
				...
				?>
                 <h1 class=" text-center font-weight-bold text-warning">Personal Information</h1> <hr color="#333333" />
                             <h3 class=" ">ID :    <?php  echo  $row['id'] . "<br />";?></br></h3> 
                             <h3 class=""> Name :  <?php  echo   $row['f_name']; echo  $row['l_name']. "<br />";?></br></h3>
                             <h3 class="">Email/Gmail Address :     <?php   echo $row['email'] . "<br />";?></br></h3>
                             <h3 class=""> Contact Number :   <?php  echo   $row['contact'] . "<br />";?></br></h3>
                             <h3 class=""> Clinic Address :   <?php  echo  $row['address'] . "<br />";?></br></h3>
                             <h3 class=""> Qualification :    <?php  echo  $row['qualification'] . "<br />";?></br></h3>
                             <h3 class=""> BMDC Registration Number: <?php  echo  $row['bmdc_reg_num'] . "<br />";?></br></h3>
                              <h3 class=""> Specialism :    <?php  echo  $row['specialist'] . "<br />". "<br />". "<br />";?></h3>
...
<div class="w3-col 18 s12">
  ...
  <div class="w3-card-4 w3-margin " style="background-color: #B8DFD8">
    <div class="w3-container">
     <hr/>
     <h1 class=" text-center font-weight-bold  text-warning">Booking Appointment</h1> <hr color="#B8DFD8" />
     ...
     <form class=" text-center text-xl-info font-weight-bold" action = "appointment_detail.php" method="POST">
      ...
      <b>
        <input type = "pid" name="pid"/>
      </b><br/><br/><br/>
      <h3> Enter This ID :<?php  echo   $row['s_id']; } ?></h3><br/>
      <b>
        <input type = "sid" name="sid"/>
      </b><br/><br/><br/>
      <h3><label for="booking_date">Select Date:</label></h3><br/>
      <b>
