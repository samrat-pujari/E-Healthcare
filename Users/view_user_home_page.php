...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header"><a class="navbar-brand text-dark" href="#myPage"><strong>e-healthcare</strong></a></div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#Appointment">Consulting<span class="caret"></span></a>
            <ul class="dropdown-menu"> 
              <li><a href="../view_consulting_hour/doctor_schedule_list.php">Consulting Hour</a></li>
              <li><a href="../messages/message.php?mid=1">Consultation</a></li>
            </ul>
          </li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox" >
      <div class="item active">
        <img src="../pic/healthcare.jpg" alt="img1" width="1500" height="800" title="User Home Page">
