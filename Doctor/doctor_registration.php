...
/*	    elseif(!filter_var($d_email,FILTER_VALIDATE_EMAIL))
	 ...
	 /*     elseif(!filter_var($d_contact,FILTER_VALIDATE_INT)){
	   ...
	   {
	   $error_msg="Please Provide Your Registration Number ";
	   }
...
<label for="contact"><b>Contact Number:</b></label><br /><br /><input type="contact"class="form-control" size="50" placeholder="Enter Your Contact Number"name="contact" pattern="[0-9]{10}" required><br /><br />
...
<label for="bmdc_reg_num"><b> Registration Number:</b></label><br /><br /><input type="bmdc_reg_num"class="form-control" size="50" name="bmdc_reg_num" placeholder="Enter Your Registration Number"required><p><strong>Only input Numeric Number, Without A-( like 1,2,3 ).</strong></p><br /><br />
